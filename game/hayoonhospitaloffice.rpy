...
# scenes for this file you need to update all the scenes below to these
$ position = "hayoonhospitalofficecloselisten" 
call sceneimg
$ position = "hayoonhospitalofficeclosetalk" 
call sceneimg
$ position = "hayoonhospitalofficeclosehi"
call sceneimg
$ position = "hayoonhospitalofficeworking" #this is supposed to be first when entering the first label of this file
call sceneimg
